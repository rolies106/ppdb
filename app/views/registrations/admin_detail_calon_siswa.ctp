<h2 class="page-title"><?php __('Detail Calon Siswa'); ?></h2>
...
<div class="detail-profile">
    ...
    <fieldset>
        <legend><?php __('Cetak Document')?></legend>
        <div class="row">
            <?php echo $this->Html->link(__('Formulir Pendaftaran',true),array('admin' => true,'controller'=>'registrations','action'=>'printDocPendaftaran',$studentDetail['Registration']['nisn']),array('class'=>'', 'target' => '_blank')); ?> | 
            <?php echo $this->Html->link(__('Surat Pernyataan',true),array('admin' => true,'controller'=>'registrations','action'=>'printDocPernyataan',$studentDetail['Registration']['nisn']),array('class'=>'', 'target' => '_blank')); ?> | 
            <?php echo $this->Html->link(__('Nilai Raport',true),array('admin' => true,'controller'=>'registrations','action'=>'printDocNilai',$studentDetail['Registration']['nisn']),array('class'=>'', 'target' => '_blank')); ?> | 
            <?php echo $this->Html->link(__('Kartu Peserta',true),array('admin' => true,'controller'=>'registrations','action'=>'printKartuPeserta',$studentDetail['Registration']['nisn']),array('class'=>'', 'target' => '_blank')); ?>
        </div>
    </fieldset>
</div>
