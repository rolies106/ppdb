<div class="block_content grid_22 prefix_1 suffix_1">
    ...
    <div class="grid_11 prefix_1 inner-border-radius box_shadow css3pie relative">
        ...
        <a href="http://www.facebook.com/sharer.php?s= 100&amp;p[title]=<?php echo htmlspecialchars(__($option['nama_aplikasi'] . ' | ' . $option['nama_sekolah'], true),ENT_QUOTES); ?>&amp;p[url]=<?php echo urlencode(Router::url(array('admin'=>false,'controller'=>'registrations','action'=>'add'),true)); ?>&amp;p[images][0]=http://content.screencast.com/users/rolies106/folders/PPDB/media/4749f414-46e4-46a4-b4a6-11adbe4b6676/logo.png&amp;p[summary]=<?php __($option['nama_aplikasi'] . ' | ' . $option['nama_sekolah'])?>" class="window_popup share_link size24"><?php __('Share di wall Facebookmu')?></a>
    </div>
    <div class="clear"></div>
