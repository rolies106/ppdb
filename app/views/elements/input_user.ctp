<?php
    echo $this->Form->input('User.username', array('label' => __('Username',true), 'class' => 'field titleHintBox', 'title'=>'Hanya karakter huruf, angka, dan garis bawah (underscore)', 'readonly' => 'readonly'));
